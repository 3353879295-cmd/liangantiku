...
当前本地及最新上传开发版本为 **1.1.5**：免费用户每天仅 3 次随机练习，其他刷题方式需会员；修复会员提示被底部导航遮挡，继续保留提交后的答题卡与本次错题解析。1,023 项测试和静态检查通过，已于 2026-09-23 上传开发版本，未提审或正式发布。详见 [会员权限与弹窗修复记录](docs/qa/2026-09-23-membership-practice-access.md)。前一版 1.1.4 的修复见 [提交后复习修复与上传记录](docs/qa/2026-09-21-submitted-review-sync.md)。此前 **1.1.3** 已于 2026-09-20 提审；该次后台状态见 [1.1.3 上传与审核记录](docs/qa/2026-09-20-release-1.1.3.md)，本次未重新核验其审核及线上状态。另见 [自动同步验收](docs/qa/2026-09-19-automatic-account-recovery.md)、[1.1.2 修复记录](docs/qa/2026-09-17-practice-resume-interaction-fix.md) 和 [支付取消修复记录](docs/qa/2026-09-16-payment-cancel-development-upload.md)。
