...
当前本地与 Git 版本基准为 **1.1.2**（标签 `v1.1.2`），对应 2026-09-17 已上传的微信小程序开发版本。包含支付取消后重试修复，以及恢复练习或云同步后无法选答案、切题和打开答题卡的修复；完整 860 项测试通过。上传与真机复测范围见 [1.1.2 修复记录](docs/qa/2026-09-17-practice-resume-interaction-fix.md) 和 [支付取消修复记录](docs/qa/2026-09-16-payment-cancel-development-upload.md)。该版本尚未提交审核或发布正式版。
